...
This document defines the minimum physical gate for the left-foot V3 candidate.
...
- Geometry: four staggered honeycomb rows; 1.5--1.8 mm graded walls; two
  longitudinal rails; and continuous 1.5 mm upper/lower load-spreading skins.
...
separation. The Z-direction coupon is mandatory because eSUN reports much lower
Z tensile strength than XY strength for this material.
