# cairo_real_sole.generate: build and verify the left V3 Side-Reveal sole.
"""Use the supplied left STL directly and emit a reproducible honeycomb candidate."""
...
def generate_real_sole(
    ...
    *,
    ...
    output_stl.parent.mkdir(parents=True, exist_ok=True)
    write_binary_stl(output_stl, triangles, "Graded Multi-Row Honeycomb V3")
    ...
    report = {
        ...
        "architecture": "graded-multi-row-honeycomb-v3",
        ...
        "design_note": (
            "Side openings are intentional. Four staggered honeycomb rows "
            "replace V2's long vertical legs. Continuous 1.5 mm upper/lower "
            "skins distribute landing load; two internal rails resist "
            "out-of-plane buckling. Heel and forefoot walls grade smoothly "
            "from 1.5 to 1.8 mm. "
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Generate the V3 honeycomb sole.")
