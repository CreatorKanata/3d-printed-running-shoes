...
This document defines the minimum physical gate for the left-foot V2 candidate.
...
- Geometry: 1.5 mm minimum walls, 30 transverse cells, two longitudinal rails,
  and continuous 1.5 mm upper/lower load-spreading skins.
